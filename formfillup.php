        ...
        if(isset($_SESSION['u_id']))
        {
         echo '<div class="formfillup container">
           ...
           <form class="f" action="sendtodatabase.php" method="post">
             ...
             <input class="form-control" type="text" name="" placeholder="'.$uf.'" readonly><br>

             <label for="last">Last Name:</label>
             <input class="form-control" type="text" name="" placeholder="'.$ul.'" readonly><br>

             <label for="userid">User Id:</label>
             <input class="form-control" type="text" name="" placeholder="'.$uid.'" readonly><br>

             <label for="email">Email Id:</label>
             <input class="form-control" type="text" name="" placeholder="'.$ema.'" readonly><br>
